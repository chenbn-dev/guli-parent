...
import top.chenbn.aclservice.entity.Permission;
import top.chenbn.aclservice.entity.RolePermission;
import top.chenbn.aclservice.entity.User;
import top.chenbn.aclservice.helper.MemuHelper;
import top.chenbn.aclservice.helper.PermissionHelper;
import top.chenbn.aclservice.mapper.PermissionMapper;
...
public class PermissionServiceImpl extends ServiceImpl<PermissionMapper, Permission>
  ...
  private void selectChildListById(String id, List<String> idList) {
    List<Permission> childList =
        baseMapper.selectList(new QueryWrapper<Permission>().eq("pid", id).select("id"));
    childList.stream()
        .forEach(
            item -> {
  ...
  private static Permission selectChildren(
      Permission permissionNode, List<Permission> permissionList) {
